...
ActiveRecord::Schema.define(version: 2021_08_01_201919) do
  ...
  create_table "rental_requests", force: :cascade do |t|
    ...
    t.index ["video_game_id"], name: "index_rental_requests_on_video_game_id"
  end
  ...
  create_table "video_genres", force: :cascade do |t|
    ...
    t.index ["video_game_id"], name: "index_video_genres_on_video_game_id"
  end
  ...
  create_table "wishlists", force: :cascade do |t|
    ...
    t.index ["video_game_id"], name: "index_wishlists_on_video_game_id"
  end

  add_foreign_key "rental_requests", "users"
  add_foreign_key "rental_requests", "video_games"
  add_foreign_key "video_games", "users"
  add_foreign_key "video_genres", "genres"
  add_foreign_key "video_genres", "video_games"
  add_foreign_key "wishlists", "users"
  add_foreign_key "wishlists", "video_games"
end
